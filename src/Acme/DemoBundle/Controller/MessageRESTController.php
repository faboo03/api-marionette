...
use Acme\DemoBundle\Entity\Message;
use Acme\DemoBundle\Form\MessageType;
...
class MessageRESTController extends VoryxController
{
    ...
    public function cgetAction(ParamFetcherInterface $paramFetcher)
    {
        try {
            ...
            $entities = $em->getRepository('AcmeDemoBundle:Message')->findBy($filters, $order_by, $limit, $offset);
            if ($entities) {
                return $entities;
            }
